...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Новий гравець</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Новий гравець</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="col-md-12 col-lg-9">
      <div class="card">
          <form class="form-horizontal" method="POST" action="{{ route('players.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                  <h4 class="card-title t-c">Гравець</h4>
                  @if (session('make'))
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        @enderror
                          <input required type="text" class="form-control" name="name" id="name" placeholder="ім'я">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        @enderror
                          <input required type="text" class="form-control" name="surname" id="surname" placeholder="прізвище">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        @enderror
                          <input required type="number" min="0" name="game_number" class="form-control" id="game_number" placeholder="ігровий номер">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        @enderror
                          <input required type="text" class="form-control" name="city" id="city" placeholder="місто">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        ...
                        @enderror
                            <input class="typeahead form-control d-none" type="text" id="hidden_team" name="team_id" value hidden>
                          <input required autocomplete="off" class="typeahead form-control" type="text" id="team_id" name="default">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9 input-group">
                        ...
                        @enderror
                          <input autocomplete="off" required name="date_birth" type="text" class="form-control" id="datepicker-autoclose" placeholder="mm/dd/yyyy">
                  ...
                  <div class="form-group row">
                      <label for="validatedCustomFile" class="col-md-3 m-t-10 text-right">Аватар</label>
                      <div class="col-md-9">
                        @error('avatar')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
